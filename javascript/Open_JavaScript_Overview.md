...
## Getting started
- [x] 1. [Setting up a Development Environment (Phase 3)](../course/readings/dev-setup.md#phase-3-frontend-development)
## JavaScript Fundamentals
- [X] 1. [Intro to JS Video](https://player.vimeo.com/video/169645510)
- [X] 2. [Object-Oriented JS: Intro](https://player.vimeo.com/video/169806088)
- [x] 3. [Object-Oriented JS: Demo](https://player.vimeo.com/video/169804475)
- [X] 4. [Closures and Callbacks](https://player.vimeo.com/video/169898573)
- [X] 5. [Debugging JS in VSCode](readings/vs-code-node-debugger.md)
- [X] 6. [Intro to JS](readings/js-intro.md)
- [X] 7. [Syntax and Useful Methods](readings/syntax-and-methods.md)
- [X] 8. [Data Types](readings/data-types.md)
- [X] 9. [Variables](readings/variables.md)
- [X] 10. [Functions](readings/functions-js.md)
- [X] 11. [Closures and Scope](readings/closures.md)
- [X] 12. [this and that](readings/this-and-that.md)
- [X] 13. [ES6 Arrow Functions](readings/fat-arrows.md)
